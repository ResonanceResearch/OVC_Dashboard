#!/usr/bin/env python3
"""
OVC_works.py — single-file OpenAlex ETL for OVC dashboard
...
# CLI
# ----------------------------
parser = argparse.ArgumentParser(description="OVC OpenAlex ETL (single-file)")
...
HEADERS = {
    "User-Agent": f"OVC-ETL (mailto:{MAILTO})",
