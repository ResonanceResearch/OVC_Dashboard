#!/usr/bin/env python3
"""
UC_BioMed_works.py — single-file OpenAlex ETL for UC_BioMed dashboard
...
# CLI
# ----------------------------
parser = argparse.ArgumentParser(description="UC_BioMed OpenAlex ETL (single-file)")
...
HEADERS = {
    "User-Agent": f"UC_BioMed-ETL (mailto:{MAILTO})",
